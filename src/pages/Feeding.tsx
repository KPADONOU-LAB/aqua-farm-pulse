...
const getAppetitColor = (appetit: string) => {
  switch (appetit) {
    ...
    case 'bon':
      return 'bg-blue-500 text-white border-blue-600 shadow-lg shadow-blue-500/25';
    case 'moyen':
  ...
  return (
    <div className="container mx-auto p-6 space-y-8 animate-fade-in bg-background">
            ...
            <div className="bg-slate-800/30 rounded-xl p-4 border border-cyan-500/20 backdrop-blur-sm">
              <ResponsiveContainer width="100%" height={320}>
                ...
                bottom: 5
                  ...
                  <XAxis dataKey="jour" stroke="#fff" fontSize={12} fontWeight="500" tick={{
                  fill: '#fff'
                }} />
                  <YAxis stroke="#fff" fontSize={12} fontWeight="500" tick={{
                  fill: '#fff'
                }} />
                  ...
                  <Bar dataKey="quantite" fill="url(#greenGradient)" radius={[6, 6, 0, 0]} stroke="rgba(16, 185, 129, 0.3)" strokeWidth={1} />
                  <defs>
      ...
      <Card className="glass-effect border-2 border-cyan-400/30 shadow-2xl backdrop-blur-lg relative overflow-hidden">
        ...
        <CardHeader className="relative z-10 pb-6 bg-gray-50">
          <div className="flex items-center justify-between">
        ...
        <CardContent className="relative z-10">
          <div className="space-y-6">
            {feedingSessions.length === 0 ? <div className="text-center py-12 relative">
