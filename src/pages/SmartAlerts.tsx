    ...
    <div className="min-h-screen p-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-4">
        {alerts.map((alert) => (
          <Card 
            key={alert.id} 
            className={`bg-card/80 backdrop-blur-md border-border/20 shadow-lg hover:shadow-xl transition-all duration-200 ${
              alert.niveau_criticite === 'critical' ? 'border-destructive/50 bg-destructive/5' : ''
            }`}
          >
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              {alert.recommandations.length > 0 && (
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1 ml-6">
                    {alert.recommandations.map((rec, index) => (
                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            id="resolution-notes"
                            placeholder="Décrivez les actions que vous avez prises pour résoudre cette alerte..."
