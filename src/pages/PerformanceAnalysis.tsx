...
const PerformanceAnalysis = () => {
  ...
  const averageScore = comparisons.length > 0 ? comparisons.reduce((sum, comp) => sum + comp.overall_score, 0) / comparisons.length : 0;
  ...
  return <div className="min-h-screen p-6 animate-fade-in bg-neutral-50">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-2 mt-2 text-white/60">
          ...
          <span className="text-sm text-black">Suivi en temps réel des KPIs</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
        ...
        return <Card key={comparison.target.cage_id} className="bg-card/80 backdrop-blur-md border-border/20 shadow-lg">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-center">
                  ...
                  <div className="absolute">
                    <div className="text-2xl font-bold" style={{
                  color: getScoreColor(comparison.overall_score)
                }}>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {comparison.deviations.fcr_deviation > 0 ? <TrendingUp className="h-3 w-3 text-destructive" /> : <TrendingDown className="h-3 w-3 text-green-600" />}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {comparison.deviations.survival_deviation >= 0 ? <TrendingUp className="h-3 w-3 text-green-600" /> : <TrendingDown className="h-3 w-3 text-destructive" />}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {comparison.deviations.weight_deviation >= 0 ? <TrendingUp className="h-3 w-3 text-green-600" /> : <TrendingDown className="h-3 w-3 text-destructive" />}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {comparison.deviations.cost_deviation <= 0 ? <TrendingDown className="h-3 w-3 text-green-600" /> : <TrendingUp className="h-3 w-3 text-destructive" />}
                    </div>
                  </div>
                </div>

                {comparison.overall_score < 70 && <div className="p-2 bg-destructive/10 rounded-lg">
      ...
      {performanceData.length > 0 && <Card className="bg-card/80 backdrop-blur-md border-border/20 shadow-lg">
          <CardHeader>
      ...
      {comparisons.length === 0 && <Card className="bg-card/80 backdrop-blur-md border-border/20 shadow-lg">
