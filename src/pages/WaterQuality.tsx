  ...
  return <div className="container mx-auto p-6 space-y-8 animate-fade-in bg-neutral-50">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-white/95 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <CardContent className="p-4">
            <div className="w-full bg-gray-200 rounded-full h-2">
              ...
              width: `${Math.min(stats.moyenneTemp / 30 * 100, 100)}%`
            }} />
            </div>
        ...
        <Card className="bg-white/95 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <CardContent className="p-4">
            <div className="w-full bg-gray-200 rounded-full h-2">
              ...
              width: `${Math.min((stats.moyennePh - 6) / (8.5 - 6) * 100, 100)}%`
            }} />
            </div>
            <p className="text-sm text-gray-600 mt-2">
        ...
        <Card className="bg-white/95 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <CardContent className="p-4">
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gradient-to-r from-purple-500 to-violet-500 h-2 rounded-full transition-all duration-500" style={{
              width: `${Math.min(stats.moyenneOxygene / 12 * 100, 100)}%`
            }} />
            </div>
            <p className="text-sm text-gray-600 mt-2">
        ...
        <Card className="bg-white/95 backdrop-blur-sm border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
          ...
          <CardContent className="p-4">
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gradient-to-r from-orange-500 to-amber-500 h-2 rounded-full transition-all duration-500" style={{
              width: `${Math.min(stats.mesuresToday / 10 * 100, 100)}%`
            }} />
            </div>
            <p className="text-sm text-gray-600 mt-2">
          ...
          <CardContent className="p-6 bg-gray-300">
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={temperatureData}>
                ...
                <Line type="monotone" dataKey="temperature" stroke="url(#temperatureGradient)" strokeWidth={3} dot={{
                fill: '#3b82f6',
                strokeWidth: 2,
                r: 5
              }} activeDot={{
          ...
          <CardContent className="p-6 bg-gray-300">
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={phData}>
                ...
                <Line type="monotone" dataKey="ph" stroke="url(#phGradient)" strokeWidth={3} dot={{
                fill: '#10b981',
                strokeWidth: 2,
                r: 5
              }} activeDot={{
      ...
      <Card className="bg-white/95 backdrop-blur-sm border border-white/20 shadow-xl">
        ...
        <CardContent className="p-6">
          {measurements.length === 0 ? <div className="text-center py-12">
              ...
              {measurements.map(measurement => <div key={measurement.id} className="bg-white rounded-xl border border-gray-200 p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                    <div className="bg-blue-50 rounded-lg p-3">
                      ...
                      <div className="w-full bg-blue-200 rounded-full h-1 mt-1">
                        <div className="bg-blue-500 h-1 rounded-full transition-all duration-500" style={{
                    width: `${Math.min(measurement.temperature / 30 * 100, 100)}%`
                  }} />
                      </div>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-lg p-3">
                      ...
                      <div className="w-full bg-green-200 rounded-full h-1 mt-1">
                        <div className="bg-green-500 h-1 rounded-full transition-all duration-500" style={{
                    width: `${Math.min((measurement.ph - 6) / (8.5 - 6) * 100, 100)}%`
                  }} />
                      </div>
                    </div>
                    ...
                    <div className="bg-purple-50 rounded-lg p-3">
                      ...
                      <div className="w-full bg-purple-200 rounded-full h-1 mt-1">
                        <div className="bg-purple-500 h-1 rounded-full transition-all duration-500" style={{
                    width: `${Math.min(measurement.oxygene_dissous / 12 * 100, 100)}%`
                  }} />
                      </div>
                    </div>
                  </div>
                  
                  {measurement.turbidite && <div className="bg-orange-50 rounded-lg p-3 mb-4">
                      <div className="flex items-center gap-2 mb-1">
                  ...
                  {measurement.observations && <div className="bg-gray-50 rounded-lg p-3 border-l-4 border-gray-400">
                      <div className="flex items-center gap-2 mb-1">
